...
#[doc = "Information about element types"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct STypeInfo {
    pub size32: u32,
    pub size64: u32,
    pub swapSize: u32,
}
#[test]
fn bindgen_test_layout_STypeInfo() {
    assert_eq!(
        ::std::mem::size_of::<STypeInfo>(),
        12usize,
        concat!("Size of: ", stringify!(STypeInfo))
    );
    assert_eq!(
        ::std::mem::align_of::<STypeInfo>(),
        4usize,
        concat!("Alignment of ", stringify!(STypeInfo))
    );
    fn test_field_size32() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<STypeInfo>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).size32) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_size32();
    fn test_field_size64() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<STypeInfo>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).size64) as usize - ptr as usize
            },
            4usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_size64();
    fn test_field_swapSize() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<STypeInfo>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).swapSize) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
...
#[doc = "Information about element types"]
pub type TTypeInfo = STypeInfo;
pub const TypeIDs_TYPEID_NONE: TypeIDs = 0;
#[doc = " No node"]
pub const TypeIDs_TYPEID_INLINE: TypeIDs = 1;
#[doc = " Empty node with just children"]
pub const TypeIDs_TYPEID_REFERENCE: TypeIDs = 2;
#[doc = " Reference to a pointer"]
pub const TypeIDs_TYPEID_REFERENCETOARRAY: TypeIDs = 3;
#[doc = " Reference to an array"]
pub const TypeIDs_TYPEID_ARRAYOFREFERENCES: TypeIDs = 4;
#[doc = " Array containing a numbers of pointers"]
pub const TypeIDs_TYPEID_VARIANTREFERENCE: TypeIDs = 5;
#[doc = " Reference with offset"]
pub const TypeIDs_TYPEID_REMOVED: TypeIDs = 6;
#[doc = " Reference with offset"]
pub const TypeIDs_TYPEID_REFERENCETOVARIANTARRAY: TypeIDs = 7;
#[doc = " Reference with offset"]
pub const TypeIDs_TYPEID_STRING: TypeIDs = 8;
#[doc = " String"]
pub const TypeIDs_TYPEID_TRANSFORM: TypeIDs = 9;
#[doc = " @see TTransformation"]
pub const TypeIDs_TYPEID_REAL32: TypeIDs = 10;
#[doc = " 32bit floating value"]
pub const TypeIDs_TYPEID_INT8: TypeIDs = 11;
#[doc = " 8bit number signed"]
pub const TypeIDs_TYPEID_UINT8: TypeIDs = 12;
#[doc = " 8bit number unsigned"]
pub const TypeIDs_TYPEID_BINORMALINT8: TypeIDs = 13;
#[doc = " 8bit number unsigned"]
pub const TypeIDs_TYPEID_NORMALUINT8: TypeIDs = 14;
#[doc = " 8bit number unsigned"]
pub const TypeIDs_TYPEID_INT16: TypeIDs = 15;
#[doc = " 16bit number signed"]
pub const TypeIDs_TYPEID_UINT16: TypeIDs = 16;
#[doc = " 16bit number unsigned"]
pub const TypeIDs_TYPEID_BINORMALINT16: TypeIDs = 17;
#[doc = " 16bit number unsigned"]
pub const TypeIDs_TYPEID_NORMALUINT16: TypeIDs = 18;
#[doc = " 16bit number unsigned"]
pub const TypeIDs_TYPEID_INT32: TypeIDs = 19;
#[doc = " 32bit number signed"]
pub const TypeIDs_TYPEID_UINT32: TypeIDs = 20;
#[doc = " 32bit number unsigned"]
pub const TypeIDs_TYPEID_REAL16: TypeIDs = 21;
#[doc = " 32bit number unsigned"]
pub const TypeIDs_TYPEID_EMPTYREFERENCE: TypeIDs = 22;
#[doc = " Reference to nothing"]
pub const TypeIDs_TYPEID_MAX: TypeIDs = 23;
#[doc = "Gr2 element types"]
pub type TypeIDs = ::std::os::raw::c_int;
extern "C" {
    #[doc = "Global holder of element type info"]
    pub static mut ELEMENT_TYPE_INFO: [TTypeInfo; 23usize];
}
extern "C" {
    #[doc = "Parses the node information from raw data"]
    #[doc = "@param data The data to parse"]
    #[doc = "@param info Output structure"]
    #[doc = "@param is64 Set this to true if you are loading a 64-bit file"]
    #[doc = "@param offset This variable should be set to the current offset of the data, the new offset will be projected into this variable"]
    #[doc = "@return true if the parsing succeeded, otherwise false"]
    pub fn TypeInfo_Parse(
        data: *const u8,
