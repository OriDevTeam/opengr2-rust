...
extern "C" {
    #[doc = "Swap bytes for endianness mismatch (type1)"]
    #[doc = "@param data the data to swap"]
    #[doc = "@param len the length of the data"]
    pub fn Platform_Swap1(data: *mut u8, len: size_t);
}
extern "C" {
    #[doc = "Swap bytes for endianness mismatch (type2)"]
    #[doc = "@param data the data to swap"]
    #[doc = "@param len the length of the data"]
    pub fn Platform_Swap2(data: *mut u8, len: size_t);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
